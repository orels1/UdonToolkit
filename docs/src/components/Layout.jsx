...
const navigation = [
  ...
  },
  {
    title: 'Attributes',
    links: [
      { title: 'Overview', href: '/docs/attributes/attributes-overview' },
      { title: 'Available Attributes', href: '/docs/attributes/attributes-list' },
    ],
  },
  {
    title: 'Beahviours',
    links: [
      { title: 'Overview', href: '/docs/behaviours/overview' },
      {
        title: 'Misc Behaviours',
        href: '/docs/behaviours/misc-behaviours',
      },
    ],
  },
  {
    title: 'Guides',
    links: [
      { title: 'Overview', href: '/docs/guides/guides-overview' },
      { title: 'Mirror Toggle', href: '/docs/guides/mirror-toggle' },
      { title: 'Teleport Players', href: '/docs/guides/teleport-players' },
    ],
  },
  {
    title: 'Systems',
    links: [
      { title: 'Flight System', href: '/docs/systems/flight-system' },
      { title: 'Camera System', href: '/docs/systems/camera-system' },
      { title: 'Presentation System', href: '/docs/systems/presentation-system' },
    ]
  },
  {
    title: 'Contributing',
  ...
  return (
    ...
    >
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:flex-grow">
        ...
        <Link href="https://github.com/orels1/UdonToolkit" className="group" aria-label="GitHub">
  ...
  return (
    <>
      <Banner
        ...
        bannerKey="v1.2.0"
        description="Now with VCC support!"
        cta="Get it now"
      ...
      <div className="relative mx-auto flex max-w-8xl justify-center sm:px-2 lg:px-8 xl:px-12">
        <div className="hidden lg:relative lg:block lg:flex-none">
          ...
          <div className="absolute top-16 bottom-0 right-0 hidden h-12 w-px bg-gradient-to-t from-zinc-800 dark:block" />
          ...
          <article>
            {(title || section) && (
              <header className="mb-9 space-y-1">
                {section && (
                  <p className="font-display text-sm font-medium text-zinc-500">
                    {section.title}
                  </p>
                )}
                {title && (
